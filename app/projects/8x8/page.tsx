        ...
        <div className="project-detail-container">
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <div className="project-detail-description">
              ...
              instances nmos_4t and pmos_4t with widths of 0.4 micrometers and
              1.2 micrometers and lengths of 0.1 micrometers to operate at 1.2
              volts. It computes pixel density as the count of ones on the grid
              and measures contour complexity by exclusive or operations between
