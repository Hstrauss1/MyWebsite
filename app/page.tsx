...
export default function Home() {
  return (
    <>
      <Background>
        {" "}
        <div className="backgroundcontainer relative min-h-screen bg-transparent overflow-visible">
          <ThemeToggle />
          <div className="py-12">
            {/* Header Section */}
            ...
            <div className="main-body">
              ...
              <div className="section">
                ...
                <div className="about-content">
                  ...
                  statistics. I thrive on solving complex technical challenges
                  and contributing to innovative, performance-driven projects.
                  Im in love with embracing challenging problems.
                </div>
              </div>
                  ...
                  <Link href="/projects/8x8" className="project-card">
                    ...
                    <div className="project-bottom">
                      ...
                      <div className="project-description-small">
                        An 8x8 pixel shape classifier built at the transistor
                        level.
                      </div>
                    </div>
                  </Link>
              ...
              <div className="section">
                ...
                <div className="languages-content">
                  64x/32x Assembly, C++/C, Python, Verilog, TCL, CMake, Ink!,
                  Rust, JavaScript
                </div>
              </div>
              ...
              <div className="section">
                ...
                <div className="coursework-content">
                  Computer Architecture, Compilers, Digital IC Design,
                  Artificial Intelligence, Data Science and Machine Learning,
                  Computer Graphics, Computer Networks, Embedded Systems,
                  Circuits, Physics, Probability and Statistics, Data-Structures
                  and Algos.
                </div>
              </div>
            </div>
