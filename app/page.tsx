            ...
            <div className="header-section">
              ...
              <div className="header-info">
                ...
                <p className="subtitle">
                  A Computer Engineer with a passion for understanding the core.
                </p>
          ...
          <div className="main-body">
            ...
            <div className="section">
              ...
              <div className="coursework-content">
                ...
                Graphics, Computer Networks, Embedded Systems, Circuits,
                Physics, Probability and Statistics, Data-Structures and Algos.
              </div>
            </div>
          </div>
